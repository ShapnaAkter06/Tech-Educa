                ...
                <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
                    ...
                    <div className="divide-y divide-gray-700">
                        <div className="py-6 space-y-2 md:grid md:grid-cols-12 md:gap-8 md:space-y-0">
                            <h3 className="font-bold md:col-span-5 text-pink-700">Why should you learn web development?</h3>
                        ...
                        <div className="py-6 space-y-2 md:grid md:grid-cols-12 md:gap-8 md:space-y-0">
                            <h3 className="font-bold md:col-span-5 text-pink-700">What programming languages should you learn for web development?</h3>
                        ...
                        <div className="py-6 space-y-2 md:grid md:grid-cols-12 md:gap-8 md:space-y-0">
                            <h3 className="font-bold md:col-span-5 text-pink-700">Is web development course easy?</h3>
