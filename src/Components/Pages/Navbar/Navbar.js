...
const Navbar = () => {
    ...
    return (
        <div>
            <header className="p-2 bg-white left-0 right-0 dark:text-gray-100">
                <div className="container flex justify-between h-16 mx-auto">
                    ...
                    <div className="items-center flex-shrink-0 hidden md:flex">
                        {user?.uid ? (
                            <>
                                ...
                                >
                                    <div className='tooltip tooltip-bottom z-10' data-tip={user.displayName}>
                                        <button>
                                            <img className='w-14 h-14 rounded-full bg-gray-500 border-gray-700' src={user?.photoURL ? user.photoURL : profiileImg} alt="" />
                                        </button>
                                    </div>
                                </Link>
                                <Link
                            ...
                            <>
                                <Link to="/registration" className="self-center px-8 py-3 rounded text-black">
                                    Registration
                                </Link>
                                <Link
                                    to="/login"
                        ...
                        >
                            ...
                            {user?.uid ? (
                                ...
                                <>
                                    <Link
                                        to="/registration"
                                        className="self-center px-8 mt-1 py-3 rounded text-black"
                                    >
                                        Registration
                                    </Link>
                                    <Link
